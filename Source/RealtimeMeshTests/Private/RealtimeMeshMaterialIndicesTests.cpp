...
bool RealtimeMeshMaterialIndicesTests::RunTest(const FString& Parameters)
{
	...
	const int32 ExpectedEndingData[] = { 0, 0, 0, 0, 0, 1, 1, 1, 2, 3, 5, 5, 5, 6, 6, 9 };
	...
	TestTrue(TEXT("StreamSegmentsElement0"), StreamSegments[0] == FRealtimeMeshStreamRange(0, 12, 4, 9));
	TestTrue(TEXT("StreamSegmentsElement1"), StreamSegments[1] == FRealtimeMeshStreamRange(0, 8, 0, 4));
	TestTrue(TEXT("StreamSegmentsElement2"), StreamSegments[2] == FRealtimeMeshStreamRange(8, 13, 9, 12));

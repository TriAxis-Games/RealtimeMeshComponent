...
bool RealtimeMeshBuilderTests::RunTest(const FString& Parameters)
{
	...
	static_assert(TAreTypesEqual<TRealtimeMeshElementAccessor<FPackedNormalQuad>::ElementType, FPackedNormal>::Value);
	...
	static_assert(std::is_constructible<FPackedNormal, FVector4f>::value);

...
#include "RealtimeMeshProviderBox.h"

FRealtimeMeshProviderBoxProxy::FRealtimeMeshProviderBoxProxy(TWeakObjectPtr<URealtimeMeshProvider> InParent, const FVector& InBoxRadius, UMaterialInterface* InMaterial)
	: FRealtimeMeshProviderProxy(InParent), BoxRadius(InBoxRadius), Material(InMaterial)
{

}

FRealtimeMeshProviderBoxProxy::~FRealtimeMeshProviderBoxProxy()
{

}

void FRealtimeMeshProviderBoxProxy::Initialize()
{
...
bool FRealtimeMeshProviderBoxProxy::GetSectionMeshForLOD(uint8 LODIndex, int32 SectionId, FRealtimeMeshRenderableMeshData& MeshData)
{
...
FRealtimeMeshCollisionSettings FRealtimeMeshProviderBoxProxy::GetCollisionSettings()
{
...
bool FRealtimeMeshProviderBoxProxy::HasCollisionMesh()
{
	return true;
}

bool FRealtimeMeshProviderBoxProxy::GetCollisionMesh(FRealtimeMeshCollisionData& CollisionData)
{
	FRealtimeMeshCollisionVertexStream& CollisionVertices = CollisionData.Vertices;
	FRealtimeMeshCollisionTriangleStream& CollisionTriangles = CollisionData.Triangles;
...
bool FRealtimeMeshProviderBoxProxy::IsThreadSafe() const
{
	return true;
}

...
using FRealtimeMeshSectionProxyPtr = TSharedPtr<FRealtimeMeshSectionProxy, ESPMode::NotThreadSafe>;
using FRealtimeMeshSectionProxyWeakPtr = TWeakPtr<FRealtimeMeshSectionProxy, ESPMode::NotThreadSafe>;


/** Single vertex buffer to hold one vertex stream within a section */
class FRealtimeMeshVertexBuffer : public FVertexBuffer
{
protected:
...
public:
	...
	FRealtimeMeshVertexBuffer(ERealtimeMeshUpdateFrequency InUpdateFrequency, int32 InVertexSize);

	~FRealtimeMeshVertexBuffer() {}
...
class FRealtimeMeshPositionVertexBuffer : public FRealtimeMeshVertexBuffer
{
public:
	FRealtimeMeshPositionVertexBuffer(ERealtimeMeshUpdateFrequency InUpdateFrequency)
		: FRealtimeMeshVertexBuffer(InUpdateFrequency, sizeof(FVector))
	{
...
class FRealtimeMeshTangentsVertexBuffer : public FRealtimeMeshVertexBuffer
{
	/** Whether this tangent buffer is using high precision tangents */
	bool bUseHighPrecision;

public:
	FRealtimeMeshTangentsVertexBuffer(ERealtimeMeshUpdateFrequency InUpdateFrequency, bool bInUseHighPrecision)
		: FRealtimeMeshVertexBuffer(InUpdateFrequency, (bInUseHighPrecision ? sizeof(FPackedRGBA16N) : sizeof(FPackedNormal)) * 2)
...
class FRealtimeMeshUVsVertexBuffer : public FRealtimeMeshVertexBuffer
{
...
public:
	FRealtimeMeshUVsVertexBuffer(ERealtimeMeshUpdateFrequency InUpdateFrequency, bool bInUseHighPrecision, int32 InNumUVs)
		: FRealtimeMeshVertexBuffer(InUpdateFrequency, (bInUseHighPrecision ? sizeof(FVector2D) : sizeof(FVector2DHalf)) * InNumUVs)
...
class FRealtimeMeshColorVertexBuffer : public FRealtimeMeshVertexBuffer
{
public:
	FRealtimeMeshColorVertexBuffer(ERealtimeMeshUpdateFrequency InUpdateFrequency)
		: FRealtimeMeshVertexBuffer(InUpdateFrequency, sizeof(FColor))
	{
...
/** Index Buffer */
class FRealtimeMeshIndexBuffer : public FIndexBuffer
{
private:	
	/* The buffer configuration to use */
...
public:
	...
	FRealtimeMeshIndexBuffer(ERealtimeMeshUpdateFrequency InUpdateFrequency, bool bUse32BitIndices);

	~FRealtimeMeshIndexBuffer() {}
...
/** Vertex Factory */
class FRealtimeMeshVertexFactory : public FLocalVertexFactory
{
public:

	FRealtimeMeshVertexFactory(ERHIFeatureLevel::Type InFeatureLevel, FRealtimeMeshSectionProxy* InSectionParent);
...
private:
	...
	FRealtimeMeshSectionProxy * SectionParent;
};
